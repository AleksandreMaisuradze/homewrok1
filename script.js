...
function Card(props) {
    return React.createElement("div", { className: "person" }, [
        React.createElement("h1", null, [`Firstname: ${props.firstname}`]),
        React.createElement("h1", null, [`Lastname: ${props.lastname}`]),
        React.createElement("h3", null, [`Email: ${props.email}`]),
        React.createElement("h3", null, [`Gender: ${props.gender}`]),
        React.createElement("h3", null, [`Age: ${props.age}`]),
        React.createElement("h3", null, [`Job: ${props.job}`]),
    ]);
}
